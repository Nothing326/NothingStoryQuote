...
public class CardStack extends RelativeLayout {
    ...
    private CardEventListener mEventListener = (CardEventListener) new DefaultStackEventListener(300);
...
//    }
    ...
    public void setThreshold(int t) {
      mEventListener = (CardEventListener) new DefaultStackEventListener(t);
