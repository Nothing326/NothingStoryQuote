 ...
 */
public class MultiViewTypeAdaptearForFavFrage extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
...
//    }
    ...
    public  class ImageVerticalTypeViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ImageVerticalTypeViewHolder(View itemView) {
            ...
            this.image = (ImageView) itemView.findViewById(R.id.thumbnail);
            this.txtTitleEng = (TextView) itemView.findViewById(R.id.titleEng);
//            favourite = (ToggleButton) itemView.findViewById(R.id.ToggleButton);

        }

    }

    public MultiViewTypeAdaptearForFavFrage(ArrayList<Story> data, Context context) {
        this.dataSet = data;
